...
```groovy
dependencies {
    implementation "com.zcool.inkstone:inkstone:0.1.54"
    annotationProcessor "com.zcool.inkstone:inkstone-processor:0.1.54"
}
```
...
> 客户端在使用此服务时通过 ServiceManager.getInstance().fetchService(serviceName)
