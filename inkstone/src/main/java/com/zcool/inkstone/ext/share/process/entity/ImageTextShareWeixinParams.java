 ...
 * 分享图文到微信好友
 */
public class ImageTextShareWeixinParams {

    private static final String _LOCAL_FLAG_KEY = "__inkstone_local_flag";
    private static final String _LOCAL_FLAG_VALUE = "ImageTextShareWeixinParams";
    ...
    public static ImageTextShareWeixinParams readFromBundle(Bundle bundle) {
        if (bundle == null) {
            Timber.e("bundle is null");
            return null;
        }
        ...
        ImageTextShareWeixinParams target = new ImageTextShareWeixinParams();
