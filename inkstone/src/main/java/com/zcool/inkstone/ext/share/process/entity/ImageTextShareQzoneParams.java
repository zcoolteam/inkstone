 ...
 * 分享图文到 QQ 空间
 */
public class ImageTextShareQzoneParams {

    private static final String _LOCAL_FLAG_KEY = "__inkstone_local_flag";
    private static final String _LOCAL_FLAG_VALUE = "ImageTextShareQzoneParams";
    ...
    public static ImageTextShareQzoneParams readFromBundle(Bundle bundle) {
        if (bundle == null) {
            Timber.e("bundle is null");
            return null;
        }
        ...
        ImageTextShareQzoneParams target = new ImageTextShareQzoneParams();
